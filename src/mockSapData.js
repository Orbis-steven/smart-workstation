// 模拟从 SAP 接收到的原始 JSON 报文 (String 格式)
import { normalizeItemLocation } from './trayNaming';
...
const rawData = {
  ...
  'TO-1003': {
    toNo: 'TO-1003',
    workOrderNo: 'WO-20010', // 同一个工单触发的另一个TO
    deliveryNo: null,
    jobType: 'outbound', // 出库
    createDate: '2026-04-13',
    status: 'pending',
  ...
  'TO-1004': {
    toNo: 'TO-1004', jobType: 'inbound', createDate: '2026-04-14', status: 'pending',
    items: [
  ...
  'TO-1005': {
    toNo: 'TO-1005', workOrderNo: 'WO-20011', deliveryNo: null, jobType: 'outbound', createDate: '2026-04-14', status: 'pending',
    items: [
      { id: '13', toNo: 'TO-1005', itemNo: '8844-3010-225-M01', description: 'Stepper Motor', tray: 'TRAY-03', bin: 'TRAY-03M03', x: 2, y: 1, qty: 1 },
    ]
  },
  'TO-1006': {
    toNo: 'TO-1006', jobType: 'inbound', createDate: '2026-04-15', status: 'pending',
    items: [
  ...
  'TO-1007': {
    toNo: 'TO-1007', workOrderNo: null, deliveryNo: 'DO-30012', jobType: 'outbound', createDate: '2026-04-15', status: 'pending',
    items: [
  ...
  'TO-1008': {
    toNo: 'TO-1008', jobType: 'inbound', createDate: '2026-04-16', status: 'pending',
    items: [
      { id: '19', toNo: 'TO-1008', itemNo: '3344-5566-778-P01', description: 'Plastic Enclosure', tray: 'TRAY-07', bin: 'TRAY-07M29', x: 15, y: 1, qty: 10 },
    ]
  },
  'TO-1009': {
    toNo: 'TO-1009', workOrderNo: 'WO-20012', deliveryNo: null, jobType: 'outbound', createDate: '2026-04-16', status: 'pending',
    items: [
  ...
  'TO-1010': {
    toNo: 'TO-1010', jobType: 'inbound', createDate: '2026-04-17', status: 'pending',
    items: [
  ...
  'TO-1011': {
    toNo: 'TO-1011', workOrderNo: null, deliveryNo: 'DO-30014', jobType: 'outbound', createDate: '2026-04-17', status: 'pending',
    items: [
      { id: '24', toNo: 'TO-1011', itemNo: '5566-7788-990-C01', description: 'Copper Wire 2mm', tray: 'TRAY-06', bin: 'TRAY-06M07', x: 4, y: 1, qty: 100 },
    ]
  },
  'TO-1012': {
    toNo: 'TO-1012', jobType: 'inbound', createDate: '2026-04-18', status: 'pending',
    items: [
  ...
  'TO-1013': {
    toNo: 'TO-1013', workOrderNo: 'WO-20014', deliveryNo: null, jobType: 'outbound', createDate: '2026-04-18', status: 'pending',
    items: [
  ...
  'TO-1014': {
    toNo: 'TO-1014', workOrderNo: null, deliveryNo: null, jobType: 'inbound', createDate: '2026-04-18', status: 'pending',
    items: [
